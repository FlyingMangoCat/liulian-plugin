...
const { changelogs, currentVersion } = readLogFile('liulian')


const yunzaiVersion = packageJson.version
const isV3 = yunzaiVersion[0] === '3'
const isLiulian = packageJson.name === 'Mangocat-yunzai'
...
let Version = {
  ...
  runtime () {
    console.log(`未能找到e.runtime，请升级至最新版${isV3 ? 'V3' : 'V2'}-Yunzai以使用liulian-plugin`)
  },
  readLogFile
}
