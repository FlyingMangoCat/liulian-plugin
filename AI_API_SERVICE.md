...
所有API端点的基础URL为：`https://liulian-ai.top/api` 或 `https://www.liulian-ai.top/api`
...
#### 创建API密钥
```
POST https://liulian-ai.top/api/ai-api/keys
...
#### 获取API密钥列表
```
GET https://liulian-ai.top/api/ai-api/keys
Authorization: Bearer USER_JWT_TOKEN
```

#### 删除API密钥
```
DELETE https://liulian-ai.top/api/ai-api/keys/:keyId
Authorization: Bearer USER_JWT_TOKEN
```
...
#### 获取可用模型列表
```
GET https://liulian-ai.top/api/ai-service/models
Authorization: Bearer YOUR_API_KEY
```

#### AI聊天接口
```
POST https://liulian-ai.top/api/ai-service/chat
Authorization: Bearer YOUR_API_KEY
Content-Type: application/json
...
#### AI文本生成接口
```
POST https://liulian-ai.top/api/ai-service/generate
Authorization: Bearer YOUR_API_KEY
Content-Type: application/json
...
#### 获取个人使用统计
```
GET https://liulian-ai.top/api/ai-api/usage
Authorization: Bearer USER_JWT_TOKEN
```
...
#### 获取所有API密钥（用于监控）
```
GET https://liulian-ai.top/api/ai-api/admin/keys
Authorization: Bearer ADMIN_JWT_TOKEN
```

#### 禁用/启用API密钥
```
PATCH https://liulian-ai.top/api/ai-api/admin/keys/:keyId
Authorization: Bearer ADMIN_JWT_TOKEN
Content-Type: application/json
...
#### 获取系统使用统计
```
GET https://liulian-ai.top/api/ai-api/admin/stats
Authorization: Bearer ADMIN_JWT_TOKEN
```
