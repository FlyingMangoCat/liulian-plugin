...
#### 获取API密钥列表
```
GET /api/ai-api/keys?userId=user123
Authorization: Bearer USER_JWT_TOKEN
```
...
#### 删除API密钥
```
DELETE /api/ai-api/keys/:keyId?userId=user123
Authorization: Bearer USER_JWT_TOKEN
```
...
#### 获取个人使用统计
```
GET /api/ai-api/usage?userId=user123
Authorization: Bearer USER_JWT_TOKEN
```
...
{
  "userId": "user123",
  "totalUsedTokens": 15000,
  "totalUsageLimit": 2000000,
  "remainingTokens": 1985000,
  "apiKeyCount": 1,
  "recentUsage": [
    {
      "model": "llama2",
