...
if (!/榴莲/.test(e.msg) && !Cfg.get('sys.qqy', false)) {
    ...
    if (randomWife2.last_sent_time>=(new Date().getTime() - 259200000)/1000){
        let msg = [
            ...
            `【${randomWife2.nickname}】 (${randomWife2.user_id}) 哒哒哒！快点趁热入洞房吧！(健康使用不要刷屏！注：九分之一概率没有老婆)`
        ]
        e.reply(msg);
    ...
    if (randomWife4.last_sent_time>=(new Date().getTime() - 259200000)/1000){
        let msg = [
            ...
            `【${randomWife4.nickname}】 (${randomWife4.user_id}) 啦啦啦！(健康使用不要刷屏！注：114514分之一概率没有老婆)`
        ]
        e.reply(msg);
    ...
    if (randomWife5.last_sent_time>=(new Date().getTime() - 259200000)/1000){
        let msg = [
            ...
            `【${randomWife5.nickname}】 (${randomWife5.user_id}) 啦啦啦！(健康使用不要刷屏！注：九分之一概率没有老婆)`
        ]
        e.reply(msg);
    ...
    if (randomWife6.last_sent_time>=(new Date().getTime() - 259200000)/1000){
        let msg = [
            ...
            `【${randomWife6.nickname}】 (${randomWife6.user_id}) 啦啦啦！(健康使用不要刷屏！注：九分之一概率没有老婆)`
        ]
        e.reply(msg);
    ...
    if (randomWife7.last_sent_time>=(new Date().getTime() - 259200000)/1000){
        let msg = [
            ...
            `【${randomWife7.nickname}】 (${randomWife7.user_id}) 啦啦啦！(健康使用不要刷屏！注：九分之一概率没有老婆)`
        ]
        e.reply(msg);
    ...
    if (randomWife8.last_sent_time>=(new Date().getTime() - 259200000)/1000){
        let msg = [
            ...
            `【${randomWife8.nickname}】 (${randomWife8.user_id}) 啦啦啦！(健康使用不要刷屏！注：九分之一概率没有老婆)`
        ]
        e.reply(msg);
