...
import { 早报 } from "./manyfunctions.js"
import { xzys } from "./manyfunctions.js"
import { dragonKing } from "./查龙王.js"
import { examples } from "./群友强制休息.js"
import { godEyesFUN,headPortraitFUN } from "./manyfunctions.js"
...
import { setu,lp } from "./manyfunctions.js"
import { dailyword,sentence } from "./manyfunctions.js"
...
let rule = {
       ...
       reg: "^#*(开启|关闭)B站推送群权限\\s*.*$",
       priority: 5,
       describe: "可以在任意地方，给任意群聊开启/关闭狗管理使用B站推送功能的权限",
  },
       setBiliPushTimeInterval: {
       reg: "^#*B站推送时间\\s*\\d+$",
       priority: 5,
