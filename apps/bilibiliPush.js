...
const BiliReqHeaders = {
  'cookie': 'buvid3=11F617CE-425E-C3A3-0A21-BB16A8A41CDA77609infoc; innersign=0; b_nut=100; i-wanna-go-back=-1; b_lsid=C48262FE_1890BD9EE5F; bsource=search_baidu; _uuid=87AFE2F9-D433-CD92-E65C-7B131C4B143179104infoc; FEED_LIVE_VERSION=V8; header_theme_version=CLOSE; buvid4=92C61BD8-074C-E2FF-CB36-9AD07A76327080079-023063018-MdJ7VJuD1CUPg%2FpxRi8Rmg%3D%3D; home_feed_column=4; browser_resolution=1100-1920; bili_jct=d637e0b1363f36e64a4e778067137be3; DedeUserID=3461566190062374; DedeUserID__ckMd5=98ed7ca7c139f8ff; sid=55dm3c80; b_ut=5; fingerprint=9652e36bc96cf2408c0f52dbf96d6e0d; buvid_fp_plain=undefined; buvid_fp=11F617CE-425E-C3A3-0A21-BB16A8A41CDA77609infoc',
...
export async function updateBilibiliPush(e) {
  ...
  if (addComms.indexOf(operComm) > -1) {
    ...
    if (res.code != 0) {
      e.reply("这东西不是UID吧？*如确认uid正确请尝试将B站ck替换为自己获取的");
      return true;
    }
