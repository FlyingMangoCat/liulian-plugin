...
const BiliReqHeaders = {
  'cookie': 'buvid3=F81719BB-EAF7-A1C3-BC93-2EFB6B8CE40025520infoc; b_nut=1675091425; CURRENT_FNVAL=4048; _uuid=1962362E-71C3-32410-5662-FC85E104E833825782infoc; rpdid=|(k|~ul))R|~0J'uY~luRY~Jl; buvid_fp_plain=undefined; fingerprint=9d974c77d05855ddf60948d8bc1d0658; bsource=search_baidu; buvid4=A909D684-64A3-DB63-51D0-11D767B44A1427340-023013023-WPcGVJxivZ%2FcYczB8jCCdw%3D%3D; i-wanna-go-back=-1; b_ut=7; theme_style=light; FEED_LIVE_VERSION=V8; header_theme_version=CLOSE; home_feed_column=4; nostalgia_conf=-1; DedeUserID=609035442; DedeUserID__ckMd5=b494dc17dd7a4acf; browser_resolution=1100-1954; buvid_fp=0edcbb2446da24f73444b57dc536aae4; b_lsid=BB78C69A_189F35D0294; bili_ticket=eyJhbGciOiJFUzM4NCIsImtpZCI6ImVjMDIiLCJ0eXAiOiJKV1QifQ.eyJleHAiOjE2OTIyNjQzMDgsImlhdCI6MTY5MjAwNTEwOCwicGx0IjotMX0.58moqYJUGD-ruJCSHtIIm965M0VuAMU1rwYxJtHlOV4HeLVwPx1SFK3XwhoWLiNB9R0lKjwZHkOV57NIrXx8iPLEItN8ucs2g4PQli_mnbHmDiA15yZdvb6HDNxbTy_s; bili_ticket_expires=1692264308; bili_jct=cbcbb9d9e54561d7b2aa552ae58798a5; sid=8j3cwvll',
...
export async function updateBilibiliPush(e) {
  ...
  if (addComms.indexOf(operComm) > -1) {
    ...
    let url = `${BiliDynamicApiUrl}?host_mid=${uid}`; const response = await fetch(url, { method: "get", headers: BiliReqHeaders });
...
function isAllowPushFunc(e) {
  if (e.isMaster) return true; // 主人当然是做什么都可以咯~
