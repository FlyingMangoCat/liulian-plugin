...
const helpPath = `${_path}/plugins/liulian-plugin/resources/修仙help`;

export async function 修仙help (e, { render }) {
  ...
  return await Common.render('修仙help/index', {
    helpCfg,
    helpGroup,
    element: 'default'
  }, { e, render, scale: 1.2 })
...
export async function versionInfo (e, { render }) {
  return await Common.render('修仙help/version-info', {
    currentVersion,
    changelogs,
    elem: 'cryo'
  }, { e, render, scale: 1.2 })
