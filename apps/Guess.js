...
const logoPath = path.join(_path, 'plugins/liulian-plugin/resources/星铁/role');
const gachaPath = path.join(_path, 'plugins/liulian-plugin/resources/星铁/side');
const version = '2.0';
const templateVersion = '2.0';
const templateName = `guessAvatar_${templateVersion}`;
const pluginName = 'games-template-star-plugin-zolay-liulian';
const render = getPluginRender(pluginName);
init();
const guessConfigMap = new Map();
function getGuessConfig(e) {
