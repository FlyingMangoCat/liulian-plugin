...
export function checkJsPlugins(e) {
...
export const rule = {
  ...
  PluginsList:
  {
    reg: "^(#|井)*(v2插件列表)$",//这里的这个*代表它前面挨着的字符可以重复：##、####、###############都是对的
    priority: 450,
  ...
  RemovePlugins:
  {
    reg: "^(#|井)*(v2移除插件)(.*)$",//*表示匹配1个或多个     .表示除个别的任意字符
    priority: 450,
  ...
  HelpMenu:
  {
    reg: "^(#|井)*(v2插件管理帮助)(.*)$", //由于添加指令会冲突所以改用新增
    priority: 450,
    describe: "帮助菜单",
  }
}
