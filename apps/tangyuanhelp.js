...
import {
	currentVersion,
	changelogs
} from "../components/Changelog (2).js";

const _path = process.cwd();
const helpPath = `${_path}/plugins/liulian-plugin/resources/tangyuanhelp`;

export async function tangyuanhelp (e, { render }) {
...
export async function versionInfo (e, { render }) {
  return await Common.render('tangyuanhelp/version-info', {
    currentVersion,
    changelogs,
    elem: 'cryo'
  }, { e, render, scale: 1.2 })
