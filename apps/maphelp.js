...
export async function maphelp (e, { render }) {
  ...
  return await Common.render('maphelp/index', {
    helpCfg,
    helpGroup,
    element: 'default'
  }, { e, render, scale: 1.2 })
...
export async function mapnumber (e, { render }) {
  return await Common.render('maphelp/version-info', {
    currentVersion,
    changelogs,
    elem: 'cryo'
  }, { e, render, scale: 1.2 })
