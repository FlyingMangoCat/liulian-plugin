...
### **说明**
`liulian-plugin`是一个云崽插件，提供原神地下地图、B站推送、插件管理等一些拓展功能，及原神/星铁猜角色、娶群友、榴莲AI、随机表情、星座运势、话痨统计、天气、多群广播消息、群聊闭嘴等群聊功能。其他功能及简介可阅读`说明.txt`了解详情，部分功能可使用`#榴莲设置`或功能专属设置进行设置
...
|[喵喵](https://gitee.com/yoimiya-kokomi) | 提供框架支持 |
